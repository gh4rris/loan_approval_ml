...
A supervised machine learning application that predicts loan approval likelihood. Includes full MLOps tracking and deployment pipeline using MLflow, Docker, AWS ECS Fargate, Application Load Balancer, and Github Actions.
...
- Application Load Balancer with multi-service routing
